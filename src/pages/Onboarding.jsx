...
if(!isLoaded){
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-32'>
      <h2 className='bg-gradient-to-br from-gray-500 via-gray-200 to-white text-transparent bg-clip-text
       font-extrabold text-7xl sm:text-8xl tracking-tighter'>I am a...</h2>
